<%@ Page Title="Manage Patient Observation" Language="C#" MasterPageFile="~/CareObs.master" AutoEventWireup="true" CodeFile="AnObservation.aspx.cs" Inherits="AnObservation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="lblManageObservationTitle" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Blue" style="z-index: 1; left: 486px; top: 224px; position: absolute; width: 296px" Text="MANAGE OBSERVATION"></asp:Label>
    


    <asp:Label ID="lblSerachByWard" runat="server" style="z-index: 1; left: 328px; top: 325px; position: absolute; width: 178px" Text="Search Patient by Ward"></asp:Label>
