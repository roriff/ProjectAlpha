...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <nav>
        ...
        <asp:Label ID="lblPulseExample" runat="server" Font-Bold="False" Font-Size="X-Small" ForeColor="Blue" style="z-index: 1; left: 202px; top: 740px; position: absolute; width: 102px" Text="e.g.  85"></asp:Label>
         ...
         <asp:Label ID="lblPatientID" runat="server" Font-Bold="True" style="z-index: 1; left: 657px; top: 284px; position: absolute" Text="PatientID"></asp:Label>
         <asp:TextBox ID="txtPatientID" runat="server" ReadOnly="True" style="z-index: 1; left: 788px; top: 282px; position: absolute; width: 180px"></asp:TextBox>
         ...
         <asp:TextBox ID="txtObservationID" runat="server" ReadOnly="True" style="z-index: 1; left: 380px; top: 282px; position: absolute; width: 180px"></asp:TextBox>
         ...
         <asp:TextBox ID="txtTemperature" runat="server" style="z-index: 1; left: 383px; top: 550px; position: absolute; width: 150px"></asp:TextBox>
         ...
         <asp:Label ID="lblDegreeCelcius" runat="server" Font-Bold="False" style="z-index: 1; left: 535px; top: 551px; position: absolute; width: 105px" Text="Degr. Celcius"></asp:Label>
