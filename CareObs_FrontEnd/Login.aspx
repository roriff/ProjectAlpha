...
<body>
    ...
    <div>
     <h2>Care Observation System Login </h2>
        <p style="border:3px solid blue; padding: 1em; height: 272px;">
            <br /> 
	        
            <asp:Button ID="btnLogIn" runat="server" OnClick="btnLogIn_Click" style="z-index: 1; left: 426px; top: 290px; position: absolute; width: 100px; height: 30px" Text="Log in" />
