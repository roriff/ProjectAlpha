...
{
    public partial class mdiCareObservation : Form
    {
        private int childFormNumber = 0;

        public mdiCareObservation()
        {
            InitializeComponent();
        }
        ...
        private void manageStaffToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //set the mdi parent of the created form as this form here
            StaffManager.MdiParent = this;
